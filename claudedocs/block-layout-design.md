...
> **Tohle místo dnes nemá test.** `internal/ops/gc_test.go` má dvě funkce
...
> netestuje nic. Krok 2 v sekci 5 ten test přidává **dřív**, než vůbec nějaké bloky
> vzniknou.
...
| `:525-558` `AllS3KeySet` | inodes ∪ volumes = vše | **ANO — Č1** |
